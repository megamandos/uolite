...
#Region "Functions/Subs"
        Public Sub DoubleClick()
            _Client.ActionBuffer.Add(ActionBufferClass.ActionType.DoubleClick, Serial)
        End Sub
        ...
        Public Sub Take(ByVal Amount As UShort)
            _Client.ActionBuffer.Add(ActionBufferClass.ActionType.PickupItem, Serial, Amount)
        End Sub
